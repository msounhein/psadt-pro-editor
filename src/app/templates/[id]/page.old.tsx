...
// Material Design Palette (Dark Theme)
  ...
  useEffect(() => {
    const fetchTemplate = async () => {
      try {
        ...
        let responseData: Template | null = null;
        try {
        ...
        if (error instanceof Error) {
          ...
          setDebugInfo(prev => ({ ...prev, apiError: "An unknown error occurred" }));
        }
        toast({
          title: "Error",
